...
const App = {
  ...
  injectTableStyles() {
    ...
    style.textContent = `
      ...
      /* ===== MEDIA QUERY - GROSSE BILDSCHIRME ===== */
      @media (min-width: 1200px) {
        /* Season bleibt zentriert auch auf großen Bildschirmen */
        #seasonContainer {
          width: 100% !important;
          max-width: 100% !important;
          display: flex !important;
        ...
        /* Goal Value kann volle Breite nutzen */
        #goalValueContainer {
  ...
  completeGoalMapWorkflow() {
    ...
    // NOTE: Workflow points are already saved to goalMapMarkers via addMarkerToStore()
    // during marker creation, so we don't need to duplicate them here.
    // The goalMapData above is for statistics/history tracking, not for display.
